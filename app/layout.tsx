...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", locale: "en_US", ...(INTERFACE_LANGUAGE_SWITCH_ENABLED ? { alternateLocale: "am_ET" } : {}), siteName: "Zema", title: "Your music, everywhere. Royalties, home.", description: "Music distribution and royalty monetization for Ethiopian & African artists.", url: "/", images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "Zema — Your music, everywhere. Royalties, home." }] },
